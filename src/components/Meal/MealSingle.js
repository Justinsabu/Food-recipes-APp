          ...
          <div className='details-head grid'>
                <div className='measures my-4'>
                      ...
                      
                    {
                          meal?.ingredients?.map((ingredient, idx) => (
                            <li key = {idx} className = "flex align-center">
                              <span className='li-icon px-3 fs-12 text-orange'>
                              <FaUtensilSpoon />
                              </span>
                              <span className='li-text fs-15 fw-6 op-09'>{ingredient}</span>
                            </li>
                          ))
                        }
                  ...
                  <div className='jt mt-4'>


                  <h6 className='fs-16 text-white'>Measure:</h6>
